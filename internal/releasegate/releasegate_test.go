...
// (test-generated screenshots land in internal/ui/shots on every headless
// UI run; committing them would bloat the repo with churn).
var skipDirs = map[string]string{
	"shots": "internal" + string(filepath.Separator) + "ui",
}
