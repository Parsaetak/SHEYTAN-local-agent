@echo off
REM SHEYTAN(TM)-Local-Agent v1.1.4 (Zeta) launcher
REM
...
REM
REM v1.1.4Z (Zeta): the functional-maturity release. The Node/React UI ships
...
REM SHEYTAN-Local-Agent-Windows-x64-v1.1.4Z.zip and the Linux x64 twin.
