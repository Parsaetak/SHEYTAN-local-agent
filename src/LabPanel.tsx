...
function statusClass(
	status: LabTaskSessionSnapshot["task"]["status"],
): string {
	return `lab-status lab-status-${status}`;
}

function verificationLabel(
	task: LabTaskSessionSnapshot["task"],
): string {
	...
	return (
		<div className="lab-overview">
			...
			{data.description ? (
				...
				<p className="lab-description muted">
					No task description.
				</p>
			)}
		...
		<section className="lab-section">
			<div className="lab-section-heading">
				...
				{verification ? (
					...
					<span className="lab-verification pending">
						NOT RUN
					</span>
				)}
			</div>
