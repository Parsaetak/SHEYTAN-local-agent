#!/usr/bin/env bash
# Build + package SHEYTAN-Local-Agent v1.1.4 (Zeta) — Windows native desktop app
# on the Wails v3 shell with the Node/Vite (React) frontend.
#
# DUAL OUTPUT:
#   1. /home/z/my-project/download/sheytan-local-agent-1.1.4.zip
...
#
#   2. /home/z/my-project/download/sheytan-local-agent-1.1.4-github.zip
...
#
# v1.1.4Z (Zeta) — the functional-maturity release:
